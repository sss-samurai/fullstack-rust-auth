...
use crate::components::authentication::validate_aut_data::{validate_otp::validate_otp, create_new_user::create_new_user};
use actix_web::web;
...
pub fn main_router(cfg: &mut web::ServiceConfig) {
    ...
    cfg.route("/create-new-user", web::post().to(create_new_user));
}
